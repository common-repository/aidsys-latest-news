...
1. Upload the `aidsys-latest-news` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Use the shortcode `[aidsys_news_ticker_panel]` in your posts, pages, or widgets to display the news ticker.
